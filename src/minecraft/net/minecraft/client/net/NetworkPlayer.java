...
public class NetworkPlayer extends EntityPlayer {
	...
	public void renderHover(Textures Textures1, float f2) {
		...
		if(this.name.equalsIgnoreCase("Notch")) {
			font3.renderString(this.displayName, 0, 0, 16776960, true);
		} else {
			font3.renderString(this.displayName, 0, 0, 0xFFFFFF, true);
		}
		...
		font3.renderString(this.name, 0, 0, 5263440, true);
