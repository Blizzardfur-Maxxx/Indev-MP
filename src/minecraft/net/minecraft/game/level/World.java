...
public final class World {
	...
	public static short floodFillCounter;
	...
	public boolean isLightBlocker(int x, int y, int z) {
		Block tile4;
		return (tile4 = Block.blocksList[this.getBlockId(x, y, z)]) == null ? false : tile4.blocksLight();
	}
	...
	public final void tick() {
		...
		if(this.skylightSubtracted > i1  &&! networkMode == true) {
